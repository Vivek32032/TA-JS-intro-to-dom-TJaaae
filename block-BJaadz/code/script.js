...
document.querySelector('.five').style['border-radius'] = '10px'
...
box1.firstElementChild.style.fontSize = '0.8rem';
// Change the background of all the alternate boxes (1, 3, 5, ....) to aliceblue
document.querySelectorAll('.box').forEach((a,i)=>i%2 !== 0?a.style.background = "aliceblue": i++)
